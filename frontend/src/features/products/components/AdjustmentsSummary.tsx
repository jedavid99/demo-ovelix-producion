...
import type { KpiItem } from '../types/adjustments.types'
import { kpiContainerVariants, kpiCardVariants } from '../constants/adjustments.constants'

interface AdjustmentsSummaryProps {
  kpiData: KpiItem[]
}

export const AdjustmentsSummary: React.FC<AdjustmentsSummaryProps> = ({ kpiData }) => {
  return (
    <motion.div
