...
import type { KpiItem } from '../types/shipments.types'

interface RemisesSummaryProps {
  kpiData: KpiItem[]
}

export const RemisesSummary: React.FC<RemisesSummaryProps> = ({ kpiData }) => {
  return (
